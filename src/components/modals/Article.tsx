...
import type { IArtcileDocs } from "@/types/articleData";
...
export function ArticleDialog({
  ...
  row?: Row<IArtcileDocs>;
  children: JSX.Element;
}) {
  const [articleData, setArticleData] = useState<IArtcileDocs>(
    row?.original ?? {
      description: "",
      image: "",
      popular: 0,
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:min-w-2xl">
        <DialogHeader>
          <DialogTitle className="font-bold text-xl">Article</DialogTitle>
        </DialogHeader>
        <div>
